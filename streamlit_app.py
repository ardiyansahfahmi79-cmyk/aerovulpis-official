...
# ##############################################################################
# FINNHUB PRICE FETCHER (REAL-TIME, 60 CALLS/MIN, GRATIS)
# ##############################################################################

def fetch_finnhub_price(symbol):
    """
    Mengambil harga real-time dari Finnhub API.
    Free tier: 60 API calls/minute. Mencakup forex, crypto, dan komoditas.
    """
    ...
    try:
        ...
        # Untuk crypto & metals, gunakan crypto_candles
        if finn_symbol in ["XAUUSD", "XAGUSD", "BTCUSD", "ETHUSD", "SOLUSD", "XRPUSD", "BNBUSD"]:
            ...
            # Untuk forex, gunakan forex_rates
...
# ##############################################################################
# CYBER-TECH CSS (termasuk CSS untuk halaman Upgrade)
# ##############################################################################
...
with st.sidebar:
    ...
    menu_selection = option_menu(
        ...
        options=["Live Dashboard", "AeroVulpis Sentinel", "Signal Analysis", "Market Sessions", "Market News", "Economic Radar", "Smart Alert Center", "Chatbot AI", "Risk Management", "Tingkatkan Level", "Settings", "Help & Support"],
        icons=["activity", "shield-shaded", "graph-up-arrow", "globe", "newspaper", "calendar-event", "bell-fill", "chat-dots", "shield-fill", "rocket-takeoff", "gear", "question-circle"],
...
# ==============================================================================
# 9. RISK MANAGEMENT (REVAMP TOTAL - COMPACT CYBER-TECH, TANPA EMOJI)
# ==============================================================================
...
# ==============================================================================
    ...
    # --- Session State untuk Payment Modal ---
    ...
    for pkg in packages:
        ...
        btn_class = "pricing-btn featured-btn" if pkg["featured"] else "pricing-btn"
    ...
    # --- Tombol Pilih Paket (5 kolom) ---
    col1, col2, col3, col4, col5 = st.columns(5)
    cols = [col1, col2, col3, col4, col5]

    for i, pkg in enumerate(packages):
        with cols[i]:
            btn_label = f"SELECT {pkg['name']}"
            if st.button(btn_label, key=f"btn_{pkg['id']}", width='stretch'):
        ...
        <div class="payment-modal-overlay" id="payment-modal">
            <div class="payment-modal">
                ...
                <div class="qr-container">
                    <img src="https://files.manuscdn.com/user_upload_by_module/session_file/310519663520709901/qris_dynamihatch.png" 
                         alt="QRIS DYNAMIHATCH" 
                         style="width:180px;height:180px;"
                         onerror="this.onerror=null;this.src='data:image/svg+xml,<svg xmlns=%22http://www.w3.org/2000/svg%22 width=%22180%22 height=%22180%22><rect width=%22180%22 height=%22180%22 fill=%22white%22/><text x=%2290%22 y=%2295%22 text-anchor=%22middle%22 font-family=%22monospace%22 font-size=%2214%22 fill=%22black%22>QRIS</text><text x=%2290%22 y=%22115%22 text-anchor=%22middle%22 font-family=%22monospace%22 font-size=%2210%22 fill=%22gray%22>DYNAMIHATCH</text></svg>';">
                </div>
