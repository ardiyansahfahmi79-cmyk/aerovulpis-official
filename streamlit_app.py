...
# ##############################################################################
# MARKET DATA FUNCTIONS (MULTI-SOURCE: Twelve Data → Cache → yfinance)
# ##############################################################################

def fetch_twelvedata_price(symbol):
    """
    Fetch harga dari Twelve Data API (REST).
    Free tier: 800 request/day.
    """
...
def get_market_data(ticker_symbol):
    ...
    1. Twelve Data API (REST - real-time untuk forex/XAU/crypto)
...
# ==============================================================================
    ...
    with st.expander("LIVE DASHBOARD"):
        ...
        **Fitur:**
        - Harga live dengan indikator sumber data (TWELVEDATA / CACHE / LIVE)
