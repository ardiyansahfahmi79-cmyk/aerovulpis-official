...
# ====================== ICMARKET PRICE FETCH (FIXED - AKURAT) ======================
def get_icmarket_price(symbol):
    """
    IC Market cTrader - Harga AKURAT dari broker asli
...
# ====================== 11. HELP & SUPPORT ======================
    ...
    with st.expander("LIVE DASHBOARD"):
        ...
        **Features:**
        ...
        - Technical Strength Cyber Gauge with animated glow effects
    ...
    with st.expander("SMART ALERT CENTER"):
        ...
        **Current Price** displayed from system cache with proper formatting per instrument type.
        **Features:** 24/7 monitoring, instant alerts, multiple concurrent alerts.
        """)
