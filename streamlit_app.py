...
# ##############################################################################
# GOOGLE OAUTH AUTHENTICATION (FIXED - 403 ERROR + FALLBACK)
# ##############################################################################
...
def handle_google_oauth():
    ...
    Masalah 403: Redirect URL tidak match. Solusi:
    1. Gunakan REDIRECT_URL dari secrets
    2. Fallback ke implicit flow jika PKCE gagal
    3. Manual token exchange via REST API
    
    KONFIGURASI YANG HARUS DICEK:
    - Supabase Dashboard → Authentication → URL Configuration:
      Site URL = https://[app].streamlit.app
      Redirect URLs: tambah https://[app].streamlit.app/**
    - Google Cloud Console → APIs → Credentials → OAuth 2.0:
      Authorized redirect URIs:
        https://[ID].supabase.co/auth/v1/callback
        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    error_msg = f"AUTH FAILED: {str(e1)[:50]}"
