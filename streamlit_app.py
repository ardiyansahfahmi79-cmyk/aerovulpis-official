...
def activate_key(user_id, key_code):
    ...
    try:
        ...
        # --- PERBAIKAN BUG AKTIVASI (duplicate key) ---
...
# ==============================================================================
# 10. TINGKATKAN LEVEL (UPGRADE PAGE) - PERBAIKAN TOTAL
# ==============================================================================
    ...
    # JIKA USER SEDANG MEMBUKA HALAMAN PEMBAYARAN
    if st.session_state.show_payment_modal:
        ...
        # Memanfaatkan st.code bawaan Streamlit yang memiliki tombol "Copy" otomatis
    ...
    # JIKA USER BELUM MEMILIH PAKET (TAMPILAN DEFAULT)
    else:
        st.markdown("""
        ...
        # Build HTML cards - tanpa spasi awal agar tidak dibaca sebagai kode
...
<ul class="pricing-features">{features_html}</ul>
        ...
        st.markdown("<br>", unsafe_allow_html=True)
        # Tombol SELECT di bawah kartu, lebih responsif
        for pkg in packages:
